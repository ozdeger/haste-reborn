...
The releases below are the original Haste by Jim Fleming, kept for the record. Anything
they describe predates the Unity 6 rewrite and much of it no longer applies.
